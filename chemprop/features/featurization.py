...
class BatchMolGraph:
    ...
    def __init__(self, mol_graphs: List[MolGraph], args: Namespace):
        ...
        for i,mol_graph in enumerate(mol_graphs):
            batch_indices.extend([i+1] * mol_graph.n_atoms)
        ...
        self.batch = torch.LongTensor(batch_indices)
    ...
    def get_components(self) -> Tuple[torch.FloatTensor, torch.FloatTensor,
        ...
        """
        return self.f_atoms, self.f_bonds, self.a2b, self.b2a, self.b2revb, self.a_scope, self.b_scope, self.bonds, self.batch
