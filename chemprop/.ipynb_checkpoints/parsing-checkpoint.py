...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--eps_max', type=float, default=0.05,
                        help='eps_max for perturbation')
    parser.add_argument('--topk', type=float, default=0.3,
                        help='choose top atoms to perturb')
    parser.add_argument('--adv_w', type=float, default=1,
                        help='adv_loss weight')
    parser.add_argument('--beta', type=float, default=0.7,
                        help='evidence calibration weight')
    
    # annealing_step
    parser.add_argument('--annealing_step', type=int, default=4,
                        help='annealing_step')
    # clip norm
    parser.add_argument('--clip_norm', type=float, default=5.0,
                        help='clip norm')
    # attn_head
    parser.add_argument('--atten_head', type=int, default=4,
                        help='atten_head')
    # attn_dropout
    parser.add_argument('--atten_dropout', type=float, default=0.2,
                        help='attn_dropout')
    parser.add_argument('--lam', type=float, default=1,help='evidence reg lam')
    # use_dropout bool
    parser.add_argument('--use_dropout', default=False,
                        help='use dropout to quantify uncertainty')
    ...
    parser.add_argument('--split_type', type=str, default='scaffold_split',
                        choices=['random', 'scaffold_balanced', 'predetermined', 'crossval', 'index_predetermined','scaffold_split'],
